...
from keyboards_my.note_kb import rule_note_kb


# принимает объект класса Message и возвращает питоновский словарь со значениями
...
# выполняет отправку заметки с любым типом контента
...
#  массово отправляет заметки пользователю.
